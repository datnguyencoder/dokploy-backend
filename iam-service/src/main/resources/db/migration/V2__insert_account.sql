...
VALUES ('admin@admin.com', '$2a$12$P.xnkEV7SRbCblNUNaSdVeTtBJovmHVHI2tCQvdF.UXvYjIJ5T5FO', '1');

INSERT INTO user (email, password, role_id)
VALUES ('staff@staff.com', '$2a$12$7a1lC0FPGbKtEUHSHGsoKuAeVIe2bz4I5y3C0BxfxVOEAi8CQvdHe', '3');

INSERT INTO user (email, password, role_id)
VALUES ('doctor@doctor.com', '$2a$12$8ARJfwCUkIquRBcId0jJU.11GIYfm67fTk2ljtXgQ5ChhvQaDKexq', '4');

INSERT INTO user (email, password, role_id)
VALUES ('manager@manager.com', '$2a$12$3OzC4ly.Gdafest4Mc.xH.htepxkPUpD6KM4ayL8q7d8Go3YYPQBa', '2');